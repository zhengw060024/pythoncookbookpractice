...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','exCookbook2.19.2.py',115),
  ('statement -> expression','statement',1,'p_statement_expr','exCookbook2.19.2.py',119),
  ('expression -> expression + expression','expression',3,'p_expression_binop','exCookbook2.19.2.py',123),
  ('expression -> expression - expression','expression',3,'p_expression_binop','exCookbook2.19.2.py',124),
  ('expression -> expression * expression','expression',3,'p_expression_binop','exCookbook2.19.2.py',125),
  ('expression -> expression / expression','expression',3,'p_expression_binop','exCookbook2.19.2.py',126),
  ('expression -> - expression','expression',2,'p_expression_uminus','exCookbook2.19.2.py',133),
  ('expression -> ( expression )','expression',3,'p_expression_group','exCookbook2.19.2.py',137),
  ('expression -> NUMBER','expression',1,'p_expression_number','exCookbook2.19.2.py',141),
  ('expression -> NAME','expression',1,'p_expression_name','exCookbook2.19.2.py',145),
]
